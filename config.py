...
NEWS_MAX_ITEMS_PER_LOCAL_CITY = 40
...
# ---------------------------------------------------------------------------
# ③ 地域バランス (合計およそ1600件のピンを狙う設定。2026-07-09に1000→1600へ拡大)
# ---------------------------------------------------------------------------
...
# 0.75 = ローカル75%・トップ25%を目安に選抜(2026-07-09: 珍ニュース・地元ネタを増やす方針で0.6から引き上げ)。
# トップを厚くしたければ下げる。
LOCAL_SELECT_RATIO = 0.75
